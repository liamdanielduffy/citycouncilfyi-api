...
class LegistarAPIEventScraperZip(LegistarAPIEventScraperBase):
    ...
    '''
    WEB_URL = 'https://nyc.legistar.com'
    BASE_URL = 'nyc.legistar.com'
    EVENTSPAGE = 'https://nyc.legistar.com/Calendar.aspx'
    TIMEZONE = 'EST'
